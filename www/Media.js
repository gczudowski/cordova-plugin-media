...
var Media = function(src, successCallback, errorCallback, statusCallback, options) {
    console.log('#debug create Media object with options', options);
    ...
    this._duration = -1;
    this._position = -1;
    exec(null, this.errorCallback, "Media", "create", [this.id, this.src, finalOptions]);
};
...
Media.prototype.play = function (options) {
    console.log('#debug Media play');
    const finalOptions = options || {
        isLooping: false,
    };

    console.log('#debug play finalOptions', finalOptions);

    exec(null, null, "Media", "startPlayingAudio", [this.id, this.src, finalOptions]);
};
...
Media.prototype.release = function() {
    console.log('#debug Media release');
...
Media.prototype.setVolume = function(volume) {
    console.log('#debug Media setVolume');
